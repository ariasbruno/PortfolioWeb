  ...
  return (
    <section id="about" className="py-20 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 max-w-3xl mx-auto bg-white rounded-xl overflow-hidden shadow-xl dark:bg-gray-900">
          <div className="p-8">
            <div className="flex items-center gap-2 mb-4 text-blue-600 dark:text-yellow-400">
              <MapPin size={18} />
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <ul className='space-y-3'>
                <li>
                  <span className='font-bold text-blue-600 dark:text-yellow-400'>QuickNotes</span>: Mi primer proyecto significativo, donde me propuse el desafío de construir una aplicación de notas utilizando exclusivamente HTML, CSS y JavaScript vanilla (100%), consolidando así mis bases fundamentales.
                </li>
                <li>
                <span className='font-bold text-blue-600 dark:text-yellow-400'>Madetodo<span className='text-sm italic text-gray-500 dark:text-gray-400'>(Aun no esta subido)</span></span>: Un proyecto ambicioso inspirado en una plataforma web existente. Avancé considerablemente en su desarrollo utilizando strapi 5 y nextjs 15, buscando replicar y mejorar funcionalidades. La sección de integración de pagos representó un desafío que me llevo a pausarlo temporalmente para adquirir conocimientos más específicos en esa área.
                </li>
                <li>
                <span className='font-bold text-blue-600 dark:text-yellow-400'>Rincón Casero</span>: Recientemente finalicé el desarrollo de esta aplicación web completa para un emprendimiento familiar, enfocada en la gestión de menú y pedidos online para un local de pizzas y empanadas.
                </li>
                <li>

                <span className='font-bold text-blue-600 dark:text-yellow-400'>Thermal Ticket(Android)<span className='text-sm italic text-gray-500 dark:text-gray-400'>(Aun no esta subido)</span></span>: Paralelamente, estoy creando una aplicación Android con React Native destinada a la impresión de facturas y tickets de venta mediante una impresora térmica, también para el emprendimiento familiar.
                </li>
              </ul>
            </div>
          </div>
